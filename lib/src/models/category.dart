...
class Category {
  ...
  Category({this.id, this.name, this.count, this.icon, this.selected, this.color});
  ...
  static Future<String> returnCategoryParams(List<Category> categoryList) async {
  ...
  static Future<void> getAndSaveCategories() async {
    ...
    final http.Response response = 
      await http.get(Constants.WORDPRESS_URL+'wp/v2/categories', 
        headers: {
