...
class ReviewsList {
  ...
  ReviewsList() {
    _reviewsList = [
      Review(
          User.basic('Maria R. Garza', 'img/user0.jpg', UserState.available),
          ...
          3.2),
      Review(
          User.basic('George T. Larkin', 'img/user1.jpg', UserState.available),
          'There are a few foods that predate colonization, and the European colonization of the Americas brought about the introduction of a large number of ingredients',
          3.2),
      Review(
          User.basic('Edward E. Linn', 'img/user3.jpg', UserState.available),
          'There are a few foods that predate colonization, and the European colonization of the Americas brought about the introduction of a large number of ingredients',
          3.2),
      Review(
          User.basic('George T. Larkin', 'img/user0.jpg', UserState.available),
          'There are a few foods that predate colonization, and the European colonization of the Americas brought about the introduction of a large number of ingredients',
          3.2),
      Review(User.basic('Laurie Z. Bergeron', 'img/user1.jpg', UserState.available),
